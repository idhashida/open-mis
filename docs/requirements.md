...
[Мб не надо вообще договОры делать, поскольку они все одинаковые будут]: #

#### ⬤ Сделка
**Сделка** - заключение договора на оказание услуг между компанией владельца и клиентом.
#### ⬤ Статус сделки
**Статус сделаки** - определенная стадия жизненного цикла сделки.
...
Данная страница позволяет пользователю самостоятельно создать учетную запись с минимальным набором прав. В последующем администратор системы может добавить права к этой учетной записи и привязать пользователя к той или иной компании.
