...
Разрабатываемая CRM-подобная система предназначена для учёта клиентов частных клиник, сделок и продаж компании с целью обеспечить структурированное хранение данных и дальнейший их анализ, а также автоматизировать этап регистратуры (запись на приём, запись на обследование, запись на анализы и т.д.).
